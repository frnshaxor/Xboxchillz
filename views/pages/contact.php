<?php
/**
 * Contact page — public contact info with Telegram, WhatsApp, Email cards.
 * Expected variables: $contactTitle, $contactSubtitle, $contactTelegram, $contactWhatsapp, $contactEmail, $site
 */
$contactTitle    = $contactTitle ?? 'Hubungi Admin';
$contactSubtitle = $contactSubtitle ?? 'Pilih platform yang paling nyaman untuk Anda.';
