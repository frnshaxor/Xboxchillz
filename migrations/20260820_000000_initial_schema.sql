...
INSERT IGNORE INTO settings(name,value) VALUES
 ...
 ('contact_title','Hubungi Admin'),
 ('contact_subtitle','Pilih platform yang paling nyaman untuk Anda. Kami siap membantu.'),
 ('contact_telegram',''),
 ('contact_whatsapp',''),
 ('contact_email',''),
 ('cache_ver','1');
...
ALTER TABLE access_tokens ADD COLUMN IF NOT EXISTS expires_at TIMESTAMP NULL DEFAULT NULL AFTER last_used_at;
